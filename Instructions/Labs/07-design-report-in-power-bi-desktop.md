...
15. Enter the account details provided to you (check out the **Resources**).
...
19. Leave the Microsoft Edge browser window open.
...
25. In the visual fields pane (not the **Fields** pane—the visual fields pane is located beneath the **Visualizations** pane), notice that the fields are assigned to the **Shared Axis** and **Column Values** areas.

	![Picture 27](Linked_image_Files/07-design-report-in-power-bi-desktop_image28.png)

	*By dragging fields into a visual, they will be added to the default area. For precision, you can drag fields directly into the areas, as you will do next.*

26. From the **Fields** pane, drag the **Sales | Profit Margin** field into the **Line Values** area.
...
28. In the visual fields pane, in the **Shared Axis** area, for the **Month** field, click the down-arrow, and then select **Show Items With No Data**.
...
33. Add the following fields to the visual areas:
...
37. Add the following fields to the visual areas:
...
7. Add the **Date | Fiscal** hierarchy to the matrix **Rows** area.

	![Picture 46](Linked_image_Files/07-design-report-in-power-bi-desktop_image42.png)

8. Add the following five **Sales** table fields to the **Values** area:
...
9. In the **Filters** pane (located at the left of the **Visualizations** pane), notice the **Filter On This Page** area (you may need to scroll down).

	![Picture 57](Linked_image_Files/07-design-report-in-power-bi-desktop_image44.png)

10. From the **Fields** pane, drag the **Product | Category** field into the **Filter On This Page** area.
...
12. Add each of the following **Product** table fields to the **Filter On This Page** area, collapsing each, directly beneath the **Category** card:
...
2. To simulate the row-level security filters during report design and testing, add the **Salesperson (Performance) | Salesperson** field to the **Filters** pane, inside the **Filters On This Page** area.
...
10. Add the following fields to the visual areas:
...
12. Hover the cursor over the map visual, and then at the top-right, click the **In Focus** icon.
